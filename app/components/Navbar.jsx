...
const Navbar = () => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
        ...
        <nav className={`w-full fixed px5 lg:px-8 xl:px-[8%] py-4 
        flex items-center justify-between z-50 ${isScroll ? 
        "bg-white border-opacity-50 backdrop-blur-lg shadow-sm":""}`}>
            <a href="#top">
            ...
            <div className='flex items-center ga'>
                ...
                top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 trasition duration-500'>
                    ...
                    <li><a className='font-Ovo' onClick={closeMenu} href="#service">Servies</a></li>
